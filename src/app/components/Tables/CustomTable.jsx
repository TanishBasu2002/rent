...
export default function CustomTable({
    ...
    const columnsToRender = printMode
          ? printableColumns
          : [...printableColumns, columns.find(column => column.field === 'actions')].filter(Boolean);
          ...
          >
              ...
              >
                  ...
                  >
                      <TableHead>
                          <TableRow>
                              {(printMode ? printableColumns : columnsToRender).map((column) => (
                                    <TableCell
                                          key={column.field}
                                          sx={{
