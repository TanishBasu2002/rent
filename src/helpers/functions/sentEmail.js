      ...
      <Body style={main}>
        ...
        <Container style={container}>
          ...
          <Section style={paragraphContent}>
            ...
            <Text style={paragraph}>
              نود إعلامكم بأنه تم إنشاء اتفاقية إيجار جديدة للوحدة رقم {unitNumber} في {propertyName}.
            </Text>
          </Section>
          ...
          <Section style={paragraphList}>
            ...
            <Text style={listItem}>• نوع تحصيل الإيجار: كل {rentCollectionType} أشهر</Text>
          </Section>
